...
public class Visualizer 
{
	...
	private static final int MAX_BAR_HEIGHT = 450, MIN_BAR_HEIGHT = 30;
	...
	public void createArray(int canvasWidth, int canvasHeight) {
		String input=JOptionPane.showInputDialog(new JFrame(),"Enter Array");  
		Bar bar;
	...
	public void runAll() {
		double x = PADDING;  
		int y = 1080-560-PADDING;
		double width = (double) (1530 - PADDING*2) / capacity; 
		...
		*/
		...
		g.setColor(ColorManager.CANVAS_BACKGROUND);
		g.fillRect(0, 0, 1530, 520); // clear canvas 
	...
	{
		int interval = (int) (array.length / 7.0);
		if (value < interval)
			return ColorManager.BAR_RED;
			...
			return ColorManager.BAR_PURPLE1;
		return ColorManager.BAR_PURPLE2;
